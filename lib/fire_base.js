...
function FireBasemanagerPrivate() {
  const tokenMap = {};
  ...
  // const FA_PROJECT_ID = hostJson.project_id
  // const FA_PRIVATE_KEY_ID = hostJson.private_key_id
  // const FA_PRIVATE_KEY = hostJson.private_key
  // const FA_CLIENT_EMAIL = hostJson.client_email
  // const FA_CLIENT_ID = hostJson.client_id
  // const FA_CLIENT_X509_CERT_URL = hostJson.client_x509_cert_url
  ...
  this.storeFcmToken = (userID, token, deviceType) => {
  ...
  this.declineCallInvitation = (body) => {
  ...
  this.sendGroupCallInvitation = (body) => {
...
var FireBasemanager = (function () {
  function createInstance() {
      var object = new FireBasemanagerPrivate();
      return object;
  }

  return {
      getInstance: function () {
          if (!global.firebase_instance) {
            global.firebase_instance = createInstance();
          }
          return global.firebase_instance;
      }
  };
})();
